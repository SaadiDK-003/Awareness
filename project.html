        ...
        <div class="page-wrapper">
                                ...
                                <div class="header-top-left">
                                    <ul class="contact-info list-style">
                                        ...
                                        <li>
                                           ...
                                           <a href="/cdn-cgi/l/email-protection#0960676f66496a656064276a6664"><span class="__cf_email__" data-cfemail="8be2e5ede4cbe8e7e2e6a5e8e4e6">[email&#160;protected]</span></a>
                                        </li>
                                        <li>
                            ...
                            <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item">
                                                <a href="project-one.html" class="nav-link">Project One</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="project-two.html" class="nav-link active">Project Two</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="event-details.html" class="nav-link">Single Events</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="nav-item">
                                                        <a href="team.html" class="nav-link">Our Volunteer</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="team-details.html" class="nav-link">Volunteer Profile</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                <a href="donation.html" class="nav-link">Make Donation</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <li class="nav-item d-lg-none">
                                        <a href="donation.html" class="nav-link btn style1">Donate Now</a>
                                    </li>
                                </ul>
                ...
                <section class="project-details-wrap ptb-100">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card style1">
                                    ...
                                    <div class="project-info">
                                        <img src="assets/img/shape-1.png" alt="Image" class="project-shape">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="project-card style1">
                                    ...
                                    <div class="project-info">
                                        <img src="assets/img/shape-1.png" alt="Image" class="project-shape">
                                        <h3><a href="project-details.html">Stop Using Plastic</a></h3>
                                        <p>Lorem ipsum dolor sit amet cons ectadic elite soli tudin consec tetur netusdu ame ultrices lectus dolor sit amet egestas.</p>
                                        <a href="project-details.html" class="link style1">Read More <i class="flaticon-right-arrow"></i></a>
                                    </div>
                                </div>
                        ...
                        <ul class="page-nav list-style">
                            <li><a href="project-one.html"><i class="flaticon-left-arrow"></i></a></li>
                            <li><a class="active" href="project-one.html">1</a></li>
                            <li><a href="project-one.html">2</a></li>
                            <li><a href="project-one.html">3</a></li>
                            <li><a href="project-one.html"><i class="flaticon-right-arrow"></i></a></li>
                        </ul>
                    </div>
                </section>
            ...
            <footer class="footer-wrap">
                <div class="footer-top">
                    ...
                    <img src="assets/img/bird.png" alt="Image" class="footer-shape-three flyLeft">
                    <div class="container">
                                ...
                                <div class="footer-widget">
                                    ...
                                    <ul class="contact-info list-style">
                                        ...
                                        <li>
                                            ...
                                            <h6>Email</h6>
                                            <a href="/cdn-cgi/l/email-protection#9cf4f9f0f0f3dcfff0f5f1b2fff3f1"><span class="__cf_email__" data-cfemail="8ae2efe6e6e5cae9e6e3e7a4e9e5e7">[email&#160;protected]</span></a>
                                        </li>
                                        <li>
                                            <i class="flaticon-phone-call"></i>
                                            <h6>Phone</h6>
